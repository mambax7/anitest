...
$numdog = 'SELECT count(ID) FROM ' . $GLOBALS['xoopsDB']->prefix('stamboom') . ' WHERE ' . $f . ' ' . $l . " '" . $w . "'";
...
//query
$queryString = 'SELECT * FROM ' . $GLOBALS['xoopsDB']->prefix('stamboom') . ' WHERE ' . $f . ' ' . $l . " '" . $w . "' ORDER BY " . $o . ' ' . $d . ' LIMIT ' . $st . ', ' . $perp;
