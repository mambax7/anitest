...
$numowner = 'SELECT count(ID) FROM ' . $GLOBALS['xoopsDB']->prefix('eigenaar') . ' WHERE ' . $f . " LIKE '" . $w . "'";
...
//query
$queryString = 'SELECT * FROM ' . $GLOBALS['xoopsDB']->prefix('eigenaar') . ' WHERE ' . $f . " LIKE '" . $w . "' ORDER BY " . $o . ' ' . $d . ' LIMIT ' . $st . ', ' . $perp;
