...
define('_MI_PEDIGREE_BLOCK_MENU_TITLE', 'Pedigree menu');
define('_MI_PEDIGREE_BLOCK_MENU_DESC', 'Pedigree menu block');
define('_MI_PEDIGREE_BLOCK_RAND_TITLE', 'Dobermann Stambomen');
define('_MI_PEDIGREE_BLOCK_RAND_DESC', 'Willekeurig Pedigree block');
...
define('_MI_PEDIGREE_MENU_PERP', 'Selecteer aantal resultaten per pagina');
...
define('_PED_VSD', 'Toon/zoek honden');
define('_PED_VOB', 'Toon eigenaren/fokkers');
define('_PED_LA', 'Laatste toevoegingen');
define('_PED_AOB', 'Voeg een eigenaar/fokker toe');
define('_PED_AD', 'Voeg een hond toe');
define('_PED_M50', 'Leden top-50');
define('_PED_AIO', 'Extra informatie & wezen');
define('_PED_VM', 'Virtueel fokken');
define('_PED_AL', 'Voeg een nest toe');

//notication items
define('_DOG_DATA_NOTIFY', 'Doorgevoerde wijzigingen');
define('_DOG_DATA_NOTIFYCAP', 'Houd me op de hoogte als de gegevens van deze hond wijzigen');
define('_DOG_DATA_NOTIFYDSC', 'Notificatie bij wijziging');
define('_DOG_DATA_NOTIFYSBJ', 'Er is een wijziging doorgevoerd');

//notification categories
define('_MI_PED_DOG_NOTIFY', 'Individuele Hond');
define('_MI_PED_DOG_NOTIFY_DSC', 'omschrijving individuele hond');
