...
define('_PED_COI_CKRI_CT',
       'This page consist of inbreeding calculations for the [animalType] you selected or the "Virtual Mating" you have entered.<br>The calculations on this page are accurate to the point that they can only be made based upon the information in the database.<br>For more detailed calculations please make sure that as many as possible of the ancestors are known in the database.<br>Each information block has an explanation button which can be clicked to find information on that specific subject.<br> NOTICE : Your present COI may change when and if additional ancestry is added to the lineage. ');
define('_PED_COI_CKRI_CTS',
       "This page consist of inbreeding calculations for the [animalType] you selected or the \"Virtual Mating\" you have entered.<br>The calculations on this page are accurate to the point that they can only be made based upon the information in the database.<br>For more detailed calculations please make sure that as many as possible of the ancestors are known in the database.<br>Each information block has an explanation button which can be clicked to find information on that specific subject.<br><font color='red'> NOTICE </font>: Your present COI may change when and if additional ancestry is added to the lineage. ");
...
define('_PED_VIRUTALSTO',
       'By calculating the coefficients of Kinship, Relationship and Inbreeding for any combination of [father] and [mother] in the database a lot of statistical information can be shown about the potential [children].<br><br>This so called "Virtual Mating" can help you make a correct combination by calculating the inbred percentage (coi% or ci%) of potential [children]. You will be able to see how the (potential) parents relate to each other and which ancestors have the greatist influence on the chosen combination.<br><br>To start off with you need to select the parents of the virtual litter.<br>To complete these complex calculations at least the four grandparents need to have been entered into the database. If one of the parents is not shown in the list below it is possible that the pedigree is not "complete" enough to do a proper inbreeding calculation. The more ancestors in the pedigree the better these calculations become. The calculations go back 8 generations so it is important to make the pedigree as complete as possible. <br>Each information block has an explanation button which can be clicked to find information on that specific subject.<br><br> NOTICE :Your present COI may change when and if additional ancestry is added to the lineage.');
define('_PED_VIRUTALSTOS',
       "By calculating the coefficients of Kinship, Relationship and Inbreeding for any combination of [father] and [mother] in the database a lot of statistical information can be shown about the potential [children].<br><br>This so called \"Virtual Mating\" can help you make a correct combination by calculating the inbred percentage (coi% or ci%) of potential [children]. You will be able to see how the (potential) parents relate to each other and which ancestors have the greatist influence on the chosen combination.<br><br>To start off with you need to select the parents of the virtual litter.<br>To complete these complex calculations at least the four grandparents need to have been entered into the database. If one of the parents is not shown in the list below it is possible that the pedigree is not \"complete\" enough to do a proper inbreeding calculation. The more ancestors in the pedigree the better these calculations become. The calculations go back 8 generations so it is important to make the pedigree as complete as possible. <br>Each information block has an explanation button which can be clicked to find information on that specific subject.<br><br><font color='red'> NOTICE</font> :Your present COI may change when and if additional ancestry is added to the lineage.");
