...
define('_AM_PEDIGREE_EMPTY', 'The is nothing in the database.');
...
// Database Stuff
define('_AM_PEDIGREE_STAMBOOM_TITLE', 'stamboom Administration');
define('_AM_PEDIGREE_LABEL_STAMBOOM_EDIT', 'Edit stamboom');
define('_AM_PEDIGREE_LABEL_STAMBOOM_EDIT2', 'Edit');
define('_AM_PEDIGREE_LABEL_STAMBOOM_ADD', 'Add stamboom');
define('_AM_PEDIGREE_LABEL_STAMBOOM_DEL', 'Delete This Entry');

define('_AM_PEDIGREE_ERR_STAMBOOM_NONE', 'stamboom Not Found');
define('_AM_PEDIGREE_ERR_STAMBOOM_BAD_KEY', 'ERROR. Invalid key entered for stamboom ');

define('_AM_PEDIGREE_EIGENAAR_TITLE', 'eigenaar Administration');
define('_AM_PEDIGREE_LABEL_EIGENAAR_EDIT', 'Edit eigenaar');
define('_AM_PEDIGREE_LABEL_EIGENAAR_EDIT2', 'Edit');
define('_AM_PEDIGREE_LABEL_EIGENAAR_ADD', 'Add eigenaar');
define('_AM_PEDIGREE_LABEL_EIGENAAR_DEL', 'Delete This Entry');

define('_AM_PEDIGREE_ERR_EIGENAAR_NONE', 'eigenaar Not Found');
define('_AM_PEDIGREE_ERR_EIGENAAR_BAD_KEY', 'ERROR. Invalid key entered for eigenaar ');

define('_AM_PEDIGREE_UPGRADEFAILED0', "Update failed - couldn't rename field '%s'");
define('_AM_PEDIGREE_UPGRADEFAILED1', "Update failed - couldn't add new fields");
define('_AM_PEDIGREE_UPGRADEFAILED2', "Update failed - couldn't rename table '%s'");
define('_AM_PEDIGREE_ERROR_COLUMN', 'Could not create column in database : %s');
define('_AM_PEDIGREE_ERROR_BAD_XOOPS', 'This module requires XOOPS %s+ (%s installed)');
define('_AM_PEDIGREE_ERROR_BAD_PHP', 'This module requires PHP version %s+ (%s installed)');
define('_AM_PEDIGREE_ERROR_TAG_REMOVAL', 'Could not remove tags from Tag Module');
