...
<div id="containers">
        ...
        <form id="testtaable" method="post" action="">
            <fieldset>
                ...
                <table id="tabsdsatyle">
                    ...
                    $sqlquer        = $GLOBALS['xoopsDB']->queryF('select firstname,lastname from  ' . $xoopsDB->prefix('eigenaar') . "   where ID = '$_REQUEST[a]'");
                    $sqlquernameres = $GLOBALS['xoopsDB']->fetchBoth($sqlquer);
			  ...
			  WHERE mSVsD_eigenaar.firstname='$sqlquernameres[firstname]' and lastname='$sqlquernameres[lastname]'");
                    ...
                    <tr>
                        <td><input type="submit" name="submtresults" value="Update joeys with selected owner"/></td>
                    </tr>
                    </tbody>
                </table>
    ...
    <fieldset>
        <form action="http://www.thepetglider.com/pedigree/modules/animal/o_b_update/" method="post">
