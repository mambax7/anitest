    ...
    if (!preg_match('#^' . preg_quote($dirlimit) . '#', $currentdir)) {
        ...
        if (!empty($pictures)) {
            foreach ($pictures as $file) {
                ...
                if ($use_popup) {
                    echo '<a title="'
                         ...
                         . htmlentities($imgdir
                                        ...
                                        . $displaysize
                                        . '&title='
                                        . urlencode(@$CAPTIONS[$file] ? $CAPTIONS[$file] : $file))
                         . '\', \'showpic\', \'width='
                         . $displaysize
                         . ',height='
                         . $displaysize
                         . ',resizable=no,status=no,menubar=no,toolbar=no,scrollbars=no\'); return false;">';
                } else {
                ...
                echo '<img src="'
                     . htmlentities(phpThumbURL('src=' . urlencode($imgdir . @$_REQUEST['dir'] . '/' . $file) . '&zc=1&w=' . $thumbnailsize . '&h=' . $thumbnailsize, $thumb))
                     . '" border="1" width="'
                     . $thumbnailsize
                     . '" height="'
                     . $thumbnailsize
